...
const PrivacyPolicy: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Polityka Prywatności | Kalkulator Finansowy Nieruchomości</title>
        <meta name="description" content="Polityka prywatności Kalkulatora Finansowego Nieruchomości - informacje o przetwarzaniu danych osobowych, wykorzystaniu plików cookies i prawach użytkowników." />
        <link rel="canonical" href="https://kalkulator-finansowy-nieruchomosci.pl/polityka-prywatnosci" />
      </Helmet>
      
      <div className="container mx-auto py-12 px-4 max-w-4xl">
        <h1 className="text-3xl font-bold text-center mb-8 text-brand-blue">
          Polityka Prywatności
        </h1>
        
        <div className="bg-white p-8 rounded-lg shadow-md">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">1. Informacje ogólne</h2>
            ...
            <p className="mb-2 text-gray-700">Serwis wykorzystuje dane osobowe w następujących celach:</p>
            <ul className="list-disc pl-10 mb-4 text-gray-700">
              <li>Prowadzenie newslettera</li>
              <li>Prezentacja oferty lub informacji</li>
            </ul>
            
            <p className="mb-2 text-gray-700">Serwis realizuje funkcje pozyskiwania informacji o użytkownikach i ich zachowaniu w następujący sposób:</p>
            <ul className="list-disc pl-10 mb-4 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">2. Wybrane metody ochrony danych stosowane przez Operatora</h2>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">3. Hosting</h2>
            <p className="mb-2 text-gray-700">Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: cyberFolks.pl</p>
            <p className="mb-2 text-gray-700">Firma hostingowa w celu zapewnienia niezawodności technicznej prowadzi logi na poziomie serwera. Zapisowi mogą podlegać:</p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</h2>
            <p className="mb-2 text-gray-700">W niektórych sytuacjach Administrator ma prawo przekazywać Twoje dane osobowe innym odbiorcom, jeśli będzie to niezbędne do wykonania zawartej z Tobą umowy lub do zrealizowania obowiązków ciążących na Administratorze. Dotyczy to takich grup odbiorców:</p>
            ...
            <p className="mb-4 text-gray-700">Przysługuje Ci prawo do złożenia sprzeciwu w zakresie przetwarzania wskazanego w pkt 3.2 wobec przetwarzania danych osobowych w celu wykonania prawnie uzasadnionych interesów realizowanych przez Administratora, w tym profilowania, przy czym prawo sprzeciwu nie będzie mogło być wykonane w przypadku istnienia ważnych prawnie uzasadnionych podstaw do przetwarzania, nadrzędnych wobec Ciebie interesów, praw i wolności, w szczególności ustalenia, dochodzenia lub obrony roszczeń.</p>
            
            <p className="mb-4 text-gray-700">Na działania Administratora przysługuje skarga do Prezesa Urzędu Ochrony Danych Osobowych, ul. Stawki 2, 00-193 Warszawa.</p>
            
            <p className="mb-4 text-gray-700">Podanie danych osobowych jest dobrowolne, lecz niezbędne do obsługi Serwisu.</p>
            
            <p className="mb-4 text-gray-700">W stosunku do Ciebie mogą być podejmowane czynności polegające na zautomatyzowanym podejmowaniu decyzji, w tym profilowaniu w celu świadczenia usług w ramach zawartej umowy oraz w celu prowadzenia przez Administratora marketingu bezpośredniego.</p>
            
            <p className="mb-4 text-gray-700">Dane osobowe nie są przekazywane od krajów trzecich w rozumieniu przepisów o ochronie danych osobowych. Oznacza to, że nie przesyłamy ich poza teren Unii Europejskiej.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">5. Informacje w formularzach</h2>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">6. Logi Administratora</h2>
            <p className="mb-4 text-gray-700">Informacje zachowaniu użytkowników w serwisie mogą podlegać logowaniu. Dane te są wykorzystywane w celu administrowania serwisem.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">7. Istotne techniki marketingowe</h2>
            <p className="mb-4 text-gray-700">Operator stosuje analizę statystyczną ruchu na stronie, poprzez Google Analytics (Google Inc. z siedzibą w USA). Operator nie przekazuje do operatora tej usługi danych osobowych, a jedynie zanonimizowane informacje. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika. W zakresie informacji o preferencjach użytkownika gromadzonych przez sieć reklamową Google użytkownik może przeglądać i edytować informacje wynikające z plików cookies przy pomocy narzędzia: https://www.google.com/ads/preferences/</p>
            
            <p className="mb-4 text-gray-700">Operator stosuje korzysta z piksela Facebooka. Ta technologia powoduje, że serwis Facebook (Facebook Inc. z siedzibą w USA) wie, że dana osoba w nim zarejestrowana korzysta z Serwisu. Bazuje w tym wypadku na danych, wobec których sam jest administratorem, Operator nie przekazuje od siebie żadnych dodatkowych danych osobowych serwisowi Facebook. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">8. Informacja o plikach cookies</h2>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
            ...
            <p className="mb-2 text-gray-700">Pliki cookies wykorzystywane są w następujących celach:</p>
            <ul className="list-disc pl-10 mb-4 text-gray-700">
              <li>utrzymanie sesji użytkownika Serwisu (po zalogowaniu), dzięki której użytkownik nie musi na każdej podstronie Serwisu ponownie wpisywać loginu i hasła;</li>
              <li>realizacji celów określonych powyżej w części "Istotne techniki marketingowe";</li>
            </ul>
            
            <p className="mb-4 text-gray-700">W ramach Serwisu stosowane są dwa zasadnicze rodzaje plików cookies: „sesyjne" (session cookies) oraz „stałe" (persistent cookies). Cookies „sesyjne" są plikami tymczasowymi, które przechowywane są w urządzeniu końcowym Użytkownika do czasu wylogowania, opuszczenia strony internetowej lub wyłączenia oprogramowania (przeglądarki internetowej). „Stałe" pliki cookies przechowywane są w urządzeniu końcowym Użytkownika przez czas określony w parametrach plików cookies lub do czasu ich usunięcia przez Użytkownika.</p>
            
            <p className="mb-4 text-gray-700">Oprogramowanie do przeglądania stron internetowych (przeglądarka internetowa) zazwyczaj domyślnie dopuszcza przechowywanie plików cookies w urządzeniu końcowym Użytkownika. Użytkownicy Serwisu mogą dokonać zmiany ustawień w tym zakresie. Przeglądarka internetowa umożliwia usunięcie plików cookies. Możliwe jest także automatyczne blokowanie plików cookies Szczegółowe informacje na ten temat zawiera pomoc lub dokumentacja przeglądarki internetowej.</p>
            
            <p className="mb-4 text-gray-700">Ograniczenia stosowania plików cookies mogą wpłynąć na niektóre funkcjonalności dostępne na stronach internetowych Serwisu.</p>
            
            <p className="mb-4 text-gray-700">Pliki cookies zamieszczane w urządzeniu końcowym Użytkownika Serwisu wykorzystywane mogą być również przez współpracujące z operatorem Serwisu podmioty, w szczególności dotyczy to firm: Google (Google Inc. z siedzibą w USA), Facebook (Facebook Inc. z siedzibą w USA), Twitter (Twitter Inc. z siedzibą w USA).</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-brand-blue">9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</h2>
            <p className="mb-4 text-gray-700">Jeśli użytkownik nie chce otrzymywać plików cookies, może zmienić ustawienia przeglądarki. Zastrzegamy, że wyłączenie obsługi plików cookies niezbędnych dla procesów uwierzytelniania, bezpieczeństwa, utrzymania preferencji użytkownika może utrudnić, a w skrajnych przypadkach może uniemożliwić korzystanie ze stron www</p>
            
            <p className="mb-2 text-gray-700">W celu zarządzania ustawienia cookies wybierz z listy poniżej przeglądarkę internetową, której używasz i postępuj zgodnie z instrukcjami:</p>
            <ul className="list-disc pl-10 mb-4 text-gray-700">
              <li>Edge</li>
            ...
            <p className="mb-2 text-gray-700">Urządzenia mobilne:</p>
            <ul className="list-disc pl-10 mb-4 text-gray-700">
              <li>Android</li>
              <li>Safari (iOS)</li>
              <li>Windows Phone</li>
